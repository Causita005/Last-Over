...
public class Player : MonoBehaviour
{
    ...
    // Variables para la interacción con el diamante y el muro
    public GameObject diamante;  // El diamante que el jugador debe agarrar
    public GameObject muroBloqueado;  // El muro que se desbloqueará al agarrar el diamante
    ...
    void Update()
    {
        ...
        // Interacción con el diamante cuando el jugador presiona la tecla 'E'
    ...
    // Método para agarrar el diamante
